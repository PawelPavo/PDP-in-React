                    ...
                    {!props.autoshipActive ?
                        <div className="row " style={!props.autoshipActive ? mountedStyle : unmountedStyle}>
                            ...
                            <div className="col-7">
                                ...
                                <div onClick={props.addToCart} className={`btn w-100 rounded shadow-sm ${styles.add_to_cart}`} tabIndex="0">Add To Cart</div>
                            </div>
                        </div>
                        :
                        ""
                    ...
                    {props.autoshipActive ?
                        <div id="AddToCartAutoship" style={props.autoshipActive ? mountedStyle : unmountedStyle}>
                            ...
                            <div className="col-12 ">
                                <div onClick={props.addToCart} className={`btn w-100 mt-2 rounded shadow-sm ${styles.add_to_cart}`}>Subscribe to Autoship</div>
                            </div>
                        </div> : ""}
                        <hr className="m-0 my-2" />
            <div className="text-center">
                <small className="">Always get the lowest price and <span className="fw-bold" style={{ color: "#a41f35" }}>FREE SHIPPING</span> with AutoShip. <span href="#" className={`{text-end m-0 fw-bold} ${styles.link}`}>Learn More</span></small>
            </div>
                </div>
            </div>
        </>
