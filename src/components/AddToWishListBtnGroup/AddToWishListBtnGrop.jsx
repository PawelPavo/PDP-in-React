...
const AddToWishListBtnGroup = (props) => {
    ...
    return (
        <>
            ...
            <i class="fa-solid fa-arrow-up-from-bracket  border p-2 rounded-5 mt-2 teal" type="button" data-bs-toggle="collapse" data-bs-target="#socialMedia" aria-expanded="false" aria-controls="socialMedia"></i>
