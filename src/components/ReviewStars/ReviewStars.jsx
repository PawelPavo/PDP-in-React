...
const ReviewStars = props => {
    ...
    return (
        <>
            ...
            <div className="review"> <a href="https://www.lifeextension.com/vitamins-supplements/item01713/vitamin-d3" className={`${styles.review}`}>1239 Reviews</a> | <a href="https://www.lifeextension.com/vitamins-supplements/item01713/vitamin-d3" className={`${styles.review}`}>Write a review</a> </div>
        </>
    )
}
