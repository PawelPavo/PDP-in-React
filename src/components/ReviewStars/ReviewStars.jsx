...
const ReviewStars = props => {
    ...
    return (
        <>
            ...
            <img className="ms-3" src="https://www.lifeextension.com/-/media/lifeextension/about/product-development/best-icons.png" alt="" style={{width:"85px"}}/>
            <img className="ms-2" src={Award} alt="" style={{width:"33px"}}/>
            </div>
