    ...
    return (
        <>
            <div className="row justify-content-center">
                <div className={`col-3 border rounded text-center border-3 border-dark ${ syles.onHover}`}>
                ...
                <div className={`col-3 border rounded text-center border-3 mx-2 ${ syles.onHover}`}>
                ...
                <div className={`col-3 border rounded text-center border-3 ${ syles.onHover}`}>
