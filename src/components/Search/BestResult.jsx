    ...
    if (show) {
        return (
            <>
                ...
                <div class="card mb-3 mt-3 bg-light-blue">
                    <div class="row g-0">
    ...
    if (!show) {
        ...
        <>
                ...
                <div className="col mt-4">
                    <div className="card mb-3  rounded shadow bg-light-blue d-none d-lg-block position-relative">
                    ...
                    <div className="card mb-2 d-lg-none bg-light-blue shadow p-2 position-relative">
                    <span className="position-absolute top-0 start-50 translate-middle badge rounded-pill bg-danger fs-6">
                            Best Match
                        </span>
                    <h5 className="free_shipping mx-1 mt-3">Vitamin D3 with Sea-Iodine™</h5>
