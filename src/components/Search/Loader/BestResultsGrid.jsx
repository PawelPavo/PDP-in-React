        ...
        return (
            <>
                ...
                <div className="col mt-4">
                    <div className="card bg-light-blue" aria-hidden="true">
        ...
        return (
            <>
                ...
                <div className="col mt-4">
                    ...
                    <div className="card shadow-sm bg-light-blue shadow-lg position-relative">
                        ...
                        <div className="d-flex justify-content-between mt-2">
                            <div type="button" role="button" className="border-0 ms-2">
                                <i className="fa-regular fa-heart text-danger border p-2 rounded-5 shadow-sm bg-light"></i>
                            </div>
...
export default BestResultsGrid;